...
- [x] 함수 (선언/호출/return/재귀) - 구현 완료
- [x] 클래스 (필드/메서드/생성자/상속/super/instanceof) - 구현 완료
- [x] 정적 배열 (고정 크기 배열 생성/읽기/쓰기) - 구현 완료
- [x] 실행 전 최적화 (정적 바인딩, 상수 연산 최적화) - 구현 완료
- [x] import (Library import, alias, 순환/중복 import 오류 검사) - 구현 완료
- [x] 공장제어쉘 (프롬프트 모드 / 파일 모드 / 디버그 모드) - 구현 완료
